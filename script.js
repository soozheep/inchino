const SITE_URL = 'https://inchino.vercel.app';
  ...
  if (navigator.share) {
    try {
      await navigator.share({
        title: 'Inchino — Sonic Remedy | Soozhee',
        text: 'Inchino by Soozhee. Sonic Remedy : Audiosensory Resonance | Alien Frequencies.',
        url: SITE_URL
      });
      return;
    } catch (e) {}
